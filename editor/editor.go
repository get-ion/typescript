...
/* Package editor provides alm-tools cloud editor automation for the ion web framework.

Usage:


	import "github.com/get-ion/typescript/editor"
	[...]
...
import (
	...
	"github.com/get-ion/typescript/npm"
)

type (
	// Editor is the alm-tools adaptor.
	//
	// It holds a logger from the ion' station
...
// GetDescription EditorPlugin is a bridge between ion and the alm-tools, the browser-based IDE for client-side sources.
func (e *Editor) GetDescription() string {
	return "A bridge between ion and the alm-tools, the browser-based IDE."
}
...
func (e *Editor) start() {
	...
	// to the io.Writer that ion' user is defined from configuration
